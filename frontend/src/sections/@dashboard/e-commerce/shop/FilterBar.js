      ...
      <Grid container alignItems="center" justifyContent="space-between">
        <Grid item xs={12} sm={6} md={2}>
          <FormControl variant="standard" fullWidth>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Select {...field} label="Loại hình thuê" size="small">
                  <MenuItem value="">
                    <em>None</em>
                  </MenuItem>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Controller
            name="dimensions"
            control={control}
            render={({ field }) => <TextField {...field} label="Diện tích" variant="standard" size="small" fullWidth />}
          />
        </Grid>
        <Divider orientation="vertical" flexItem />
        <Grid item xs={12} sm={6} md={2}>
